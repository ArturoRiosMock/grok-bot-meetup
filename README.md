...
Then open http://localhost:5190/mendoza.
...
- `/mendoza`: meetup wall (Mendoza / SpaceXAI banner, chat bubble on check-in). Polls grokbot-wall at `/wall/state`, or press Space for a demo. Other URLs redirect here.
